        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('home/oauthregister')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" class="form-control" name="wx_open_id" value="<?php echo e($openId); ?>">
                       ...
                       <div class="form-group<?php echo e($errors->has('company') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="company" class="form-control" name="company" value="<?php echo e(old('company')); ?>">
