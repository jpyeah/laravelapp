    ...
    <script type="text/javascript" charset="utf-8">
         ...
         wx.ready(function(){
          ...
          wx.onMenuShareAppMessage({
			    ...
			    link: 'http://test.bibicars.com/home/share/{{$Id}}', // 分享链接

			    imgUrl: 'http://test.bibicars.com/bc.png', // 分享图标
...
<body id="app-layout">
   <div class="container"  >
        <div class="row circle text-center">
            <figure > 
              <img class="img-circle " style="width: 55px;height: 55px;"src="{{$signature}}" alt="头像"/> 
             </figure> 
            <h4  class="text-center" style="color:#000;">{{$name}}推荐二维码</h4>
        </div>    
        <div class="row col-center-block">
        <img src="{{$url}}" class="img-responsive center-block" alt="">
        </div>
