...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxbbbd0676cd872a8a'),         // AppID
    'secret'  => env('WECHAT_SECRET', '15e91893887cead09e0b00bd29deadcb'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'weixin'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'sTFoDeN3cYIaDwlKaUX9XjAtdXJmUjVDypgnRsKZB3p'),                    // EncodingAESKey
     ...
     */
     'oauth' => [
         ...
         'callback' => env('WECHAT_OAUTH_CALLBACK', '/auth_callback'),
     ],
